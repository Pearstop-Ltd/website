...
const _allBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    tocItems: [
      ...
      { id: "unspsc-classification-tools-compared-at-a-glance", label: "Tools compared at a glance" },
  ...
  },
  {
    ...
    softCta: "discovery",
    faqItems: [
      { q: "What is the difference between Sievo, Coupa, Simfoni, Spendkey, and Pearstop for spend classification?", a: "Sievo is an analytics-first platform for large enterprises where classification feeds spend analysis, savings tracking, and ESG reporting. Coupa is a full source-to-pay suite in which classification is one module inside procurement, invoicing, sourcing, and payments. Simfoni and Spendkey are narrower spend analytics platforms aimed at mid-market teams, with Simfoni also offering source-to-contract tools it acquired in 2022. Pearstop differs in kind rather than scale: it is an AI-native classification engine built specifically for hard FM, construction, and manufacturing spend, priced per line processed rather than per seat or module." },
  ...
  },
  {
    ...
    image: "/images/blog/unspsc-vs-eclass-erp-reporting.jpg",
    ...
    category: "Procurement",
    tags: ["UNSPSC", "eCl@ss", "classification standards", "ERP data quality", "material master data"],
    readingTime: 6,
    tocItems: [
      { id: "two-standards-answering-two-different-questions", label: "Two standards, two questions" },
      { id: "where-each-one-actually-gets-used", label: "Where each is actually used" },
    ...
    faqItems: [
      ...
      { q: "Which industries typically use UNSPSC instead of eCl@ss?", a: "UNSPSC is the common standard in US corporate procurement, and UK public and private sector reporting, and in category management across hard FM, cleaning, and construction, because those sectors usually optimise for spend visibility rather than deep engineering level technical detail on individual parts." },
      { q: "Which industries typically require eCl@ss instead of UNSPSC?", a: "eCl@ss is the standard requested across DACH region industrial, automation, and engineering supply chains, particularly at the material master level, where a German or DACH based manufacturing customer needs precise technical attributes for a part rather than a broader spend category." },
      { q: "Do we have to choose only one classification standard for our ERP?", a: "No. Most companies that encounter both requirements run one standard, usually UNSPSC, as the primary spend and category reporting layer, and apply the other standard as an additional attribute layer only on the specific material records where a client, parent company, or engineering stakeholder actually requires it." },
      { q: "How do we decide which standard to prioritise if our ERP and our reporting expect different ones?", a: "Start from what your own reporting is actually built around today rather than which standard sounds more technically rigorous. Confirm whether any current or likely requirement specifically calls for eCl@ss level detail, apply it only to that narrower set of records, and keep the primary standard aligned with how the business already reports spend." },
      { q: "How does Pearstop help companies handle both UNSPSC and eCl@ss requirements?", a: "Pearstop classifies spend against the taxonomy a client already reports against, UNSPSC in most hard FM, cleaning, and construction engagements, and applies additional technical attributes at the material level only where a specific client, parent company, or engineering requirement calls for it, so the two standards coexist on the same data without a full reclassification project." },
    ],
  },
  {
    slug: "data-cleaning-ai-project-manager",
    image: "/images/blog/data-cleaning-ai-project-manager.jpg",
    ...
    publishedAt: "2026-09-18",
    category: "AI & Digital",
    tags: ["AI project management", "data cleaning", "AI governance", "spend data quality", "AI implementation"],
    readingTime: 7,
    tocItems: [
      { id: "start-small-before-you-scale", label: "Start small before you scale" },
