...
Losing a tender is expensive. You have spent the hours, done the site visits, written the methodology â€” and you are out. But there is a category of tender loss even more frustrating: losing because your pricing was either too high to be competitive, or too tight to be profitable. Both outcomes have the same root cause: insufficient visibility into your own cost data.

## The pricing confidence problem

Most FM companies price tenders using a combination of historical data, estimator judgment, and margin padding that accounts for uncertainty. The estimators are usually right â€” within a range. But that range is the problem. When you do not have clean, classified historical cost data, two things happen: you pad margins to cover uncertainty, making you uncompetitive; or you compress margins under pricing pressure without data to back it up.
...
**Scenario A â€” pricing without clean data**
...
- Final price: â‚¬2.4M/year
- Outcome: second place. Winning bid was â‚¬2.25M.

**Scenario B â€” pricing with clean data**
...
- **Accuracy improves.** When estimates are grounded in actuals, the gap between estimated and actual cost on won contracts narrows â€” meaning fewer contracts that erode margin through delivery.

## The compounding effect

Better tender data does not just improve individual bids. Each completed contract produces better historical data for the next bid. The estimators get smarter benchmarks. The process gets faster. Win rates on competitive tenders improve â€” not because the service offering changed, but because the pricing became accurate enough to be competitive without being irresponsible.
