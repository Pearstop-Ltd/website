...
<!--
  NOTE FOR REVIEW (delete before publishing) — content untouched except restoring Rae's own table:
  1. Penalty table restored from the image Rae had in the original doc (figures match, transcribed as text
     for accessibility/SEO — worth a quick visual diff check against her image before publish).
  2. Bio image points to /images/clients/raeesah-headshot.png. object-position is set to 50% 20% to pull the
     crop up since her face sits higher in the shot than centre — nudge that percentage if it's still off once
     you see it rendered.
  3. This file adds "author" to frontmatter (not present in the reference file) so the template can pick Rae's
     bio over the default. If the template doesn't key off this field, flag to Dania.
-->
...
<div style={{display: 'flex', gap: '1rem', alignItems: 'flex-start', padding: '1.5rem', border: '1px solid #E8E0FC', borderRadius: '12px', marginTop: '2rem'}}>
  ...
  <div>
    ...
    <p style={{margin: 0}}>Raeesah heads up operations at Pearstop, in both the traditional and non-traditional sense. She's as committed to the internal success of the business as she is to the value clients get out of it, which is why she leads delivery on most projects and is the main point of contact for clients throughout. On compliance specifically, her focus is making sure the paperwork side of AI regulation never becomes a reason a client's data work stalls.</p>
  </div>
</div>
...
<div style={{marginTop: '2rem', padding: '1.5rem', background: '#F8F9FA', borderRadius: '12px'}}>
  <p style={{margin: '0 0 0.75rem 0', fontWeight: 600, color: '#2A3990'}}>Get the next one in your inbox</p>
  <form action="https://formspree.io/f/xyklkdkj" method="POST" style={{display: 'flex', gap: '0.5rem'}}>
    <input type="email" name="email" placeholder="you@company.com" required style={{flex: 1, padding: '0.6rem', borderRadius: '8px', border: '1px solid #DCE1F8'}} />
    <button type="submit" style={{padding: '0.6rem 1.2rem', background: '#353FFF', color: '#FFFFFF', border: 'none', borderRadius: '8px', fontWeight: 600}}>Subscribe</button>
  </form>
</div>
...
export const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "Compliant by Design: How Pearstop Answers the EU AI Act's Data Obligations",
      "description": "The EU AI Act's latest obligations took effect on 2 August 2026. Meeting them starts with data that is clean, categorised, and auditable.",
    ...
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "What EU AI Act obligations came into effect on 2 August 2026?", "acceptedAnswer": { "@type": "Answer", "text": "The latest wave covers high-risk system obligations and most remaining general obligations under the Act, building on provisions already in force since 2024 and 2025, including prohibited practices, GPAI provider duties, and transparency requirements." } },
        { "@type": "Question", "name": "What are the penalties for non-compliance with the EU AI Act?", "acceptedAnswer": { "@type": "Answer", "text": "Article 99 sets three tiers: up to 35 million euros or 7% of global turnover for prohibited practices, up to 15 million euros or 3% for non-compliance with high-risk requirements and most other obligations, and up to 7.5 million euros or 1% for supplying incorrect, incomplete, or misleading information to authorities. Whichever figure is higher applies." } },
        { "@type": "Question", "name": "How does Pearstop help with EU AI Act compliance?", "acceptedAnswer": { "@type": "Answer", "text": "Pearstop classifies and structures procurement and asset data with built-in audit trails and quality checks, so the traceability the Act requires is a by-product of data cleanup work already underway, rather than a separate compliance project." } },
        { "@type": "Question", "name": "Is EU AI Act compliance only relevant to companies building AI systems?", "acceptedAnswer": { "@type": "Answer", "text": "No. Deployers and users of AI systems carry obligations too, particularly around transparency and high-risk system documentation, so the requirement to show clean, traceable data applies broadly across the supply chain." } }
      ]
    }
  ]
}
