...
<div style="margin-top: 2rem; padding: 1.5rem; background: #F8F9FA; border-radius: 12px;">
  <p style="margin: 0 0 0.75rem 0; font-weight: 600; color: #2A3990;">Get the next one in your inbox</p>
  <form action="https://formspree.io/f/xyklkdkj" method="POST" style="display: flex; gap: 0.5rem;">
    <input type="email" name="email" placeholder="you@company.com" required style="flex: 1; padding: 0.6rem; border-radius: 8px; border: 1px solid #DCE1F8;" />
    <button type="submit" style="padding: 0.6rem 1.2rem; background: #353FFF; color: #FFFFFF; border: none; border-radius: 8px; font-weight: 600;">Subscribe</button>
  </form>
</div>
