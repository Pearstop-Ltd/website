...
Three vendors treat classification itself, rather than sourcing or contracting, as the core product.
...
Pearstop, founded in Dublin in 2024, is built around materials and services master data for hard FM, construction, and manufacturing spend specifically. Its AI classification engine was built by engineers who worked spend and asset classification directly, rather than adding an AI layer to an existing master data platform, and it maps invoice lines, legacy internal codes, and external references to UNSPSC in the same pass. That hands-on origin is why it competes with more established master data platforms on accuracy and speed despite being newer to market, and why its cost base runs leaner than a platform built around a broader governance layer.
...
None of these is a procurement suite. None will run your sourcing events or manage your contracts. What they do, they do as the primary job, not the module.
