---
title: "Maverick Spend in FM and Infrastructure: How UNSPSC Classification Exposes What You're Missing"
description: "Maverick spend is endemic in FM and construction — not because of poor discipline, but because of poor data visibility. UNSPSC classification is what makes it visible and what makes it fixable."
...
The standard narrative around maverick spend — purchasing outside negotiated contracts and frameworks — is that it is a compliance failure. Site managers buy what they need from whoever answers the phone. Project managers use their preferred subcontractors. Engineers order parts at retail because the approved vendor takes three days and the line is down now.
