...
<div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1.5rem; border: 1px solid #E8E0FC; border-radius: 12px; margin-top: 2rem;">
  <div style="width: 56px; height: 56px; border-radius: 50%; overflow: hidden; flex-shrink: 0;">
    <img src="/images/clients/raeesah-headshot.png" alt="Raeesah Thomas" style="width: 100%; height: 100%; object-fit: cover; object-position: 50% 20%;" />
  </div>
  <div>
    <p style="margin: 0; font-weight: 600; color: #2A3990;">Raeesah Thomas</p>
    <p style="margin: 0 0 0.5rem 0; font-size: 0.9rem; color: #666666;">Chief of Staff, Pearstop</p>
...
<div style="margin-top: 2rem; padding: 1.5rem; background: #F8F9FA; border-radius: 12px;">
  <p style="margin: 0 0 0.75rem 0; font-weight: 600; color: #2A3990;">Volgende artikel rechtstreeks in je inbox</p>
  <form action="https://formspree.io/f/xyklkdkj" method="POST" style="display: flex; gap: 0.5rem;">
    <input type="email" name="email" placeholder="jij@bedrijf.com" required style="flex: 1; padding: 0.6rem; border-radius: 8px; border: 1px solid #DCE1F8;" />
    <button type="submit" style="padding: 0.6rem 1.2rem; background: #353FFF; color: #FFFFFF; border: none; border-radius: 8px; font-weight: 600;">Aanmelden</button>
  </form>
</div>
