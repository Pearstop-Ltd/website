---
title: "Précision de la classification UNSPSC : Ce que signifie réellement 90 à 95 %"
description: "Que signifie en pratique une précision de 90 à 95 % pour la classification UNSPSC automatisée ? Comment est-elle mesurée, à quoi ressemblent les 5 à 10 % restants, et comment la précision s'améliore-t-elle au fil du temps ?"
...
Si vous avez fait des recherches sur la classification UNSPSC automatisée, vous avez probablement rencontré une affirmation concernant une classification automatique de 90 à 95 %. Pearstop publie ce chiffre. Plusieurs concurrents le font également.

Mais que signifie-t-il réellement ? Comment est-il mesuré ? Et qu'advient-il des 5 à 10 % restants ?

Ce sont les questions que les équipes procurement se posent avant de s'engager dans un système de classification automatisé. Cet article y répond clairement.

---

## How accuracy is defined

« Classification automatique à 90-95 % » signifie que 90 à 95 % des lignes de procurement d'un ensemble de données donné se voient attribuer un code UNSPSC commodity par le moteur automatisé, sans nécessiter d'intervention humaine.

Les 5 à 10 % restants sont des articles pour lesquels la confiance du moteur tombe en dessous d'un seuil défini. Ces articles sont signalés pour une révision humaine — un buyer ou un category manager examine chacun d'eux et confirme
