  ...
  return (
    <>
      ...
      <SoftCta
        ...
        description="In a 15-minute call we will walk through your current procurement data and show you exactly what automated classification would look like — including which standard fits your industry and reporting requirements."
