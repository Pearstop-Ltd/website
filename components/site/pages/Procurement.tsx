...
// worked example (app/[locale]/page.tsx's beforeAfterRows) — the only
// before/after spend-line example already published on the site.
...
export function ProcurementPage({ copy }: { copy: ProcurementCopy }) {
