...
export interface AiReadinessCopy {
  common: {
    sendSample: string;
...
export function AiReadinessPage({ copy }: { copy: AiReadinessCopy }) {
  ...
  const sections: SolutionSection[] = [
    ...
    },
    {
      type: "outcomeCards",
      key: "outcome",
      title: copy.benefits.b1.title,
      cards: [
        { title: copy.benefits.b1.title, body: copy.benefits.b1.copy, icon: <TrendUpIcon /> },
        { title: copy.benefits.b2.title, body: copy.benefits.b2.copy, icon: <LayersIcon /> },
        { title: copy.benefits.b3.title, body: copy.benefits.b3.copy, icon: <ZapIcon /> },
      ],
    },
    {
      type: "statBand",
  ...
  return (
    <SolutionPage
      hero={{
        ...
        visual: (
          <HeroTransform
            input={{ variant: "rawLine", label: copy.common.demoTable.lineAsEntered, value: "GEN PURP CLNR 5L" }}
