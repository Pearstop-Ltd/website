...
export function UnspscPage({ copy }: { copy: UnspscCopy }) {
  const sections: SolutionSection[] = [
    {
      ...
      stats: [
        ...
        { value: "70-90%", caption: copy.stats.s3.title },
      ],
    },
  ];
    ...
    sections.push({
      ...
      body: (
        <>
          ...
          {copy.problem.bullets ? <ProblemBullets items={copy.problem.bullets} /> : null}
        </>
      ),
    });
  }
  ...
  sections.push({
    type: "quote",
    key: "quote",
    quote: { variant: "inline", personId: "davidTorr", quote: copy.quote.text },
  });
