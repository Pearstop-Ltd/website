...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "UNSPSC, eCl@ss and CPV are all procurement classification standards, but they serve different purposes. UNSPSC is the most widely used for spend analysis and category management. eCl@ss adds detailed technical attributes per product, common in German manufacturing. CPV is used specifically for EU public procurement tenders. Most organisations only need one, chosen based on their ERP system and reporting requirements — Pearstop works with UNSPSC as the most common standard for spend analytics."
      }
    },
    {
      "@type": "Question",
