    ...
    <>
      ...
      <section>
        <div className="container">
          ...
          <div className="bene-cards">
            {[
              { title: t("moreCards.items.0.title"), copy: t("moreCards.items.0.copy"), href: `${prefix}/spend-visibility` },
              { title: t("moreCards.items.1.title"), copy: t("moreCards.items.1.copy"), href: `${prefix}/procurement-consultancies` },
              { title: t("moreCards.items.2.title"), copy: t("moreCards.items.2.copy"), href: `${prefix}/spend-cube` }
            ].map((solution) => (
