  ...
  return (
    <>
      ...
      <section className="about-leadership">
        <div className="container">
          <SectionTitle title="Leadership Team" lead="A group of problem-solvers who love untangling complexity. We are technical enough to build it, and practical enough to make it work for real businesses." />
