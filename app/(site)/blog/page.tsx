...
function getMdxFrontmatter(slug: string): { title?: string; description?: string } {
  const filePath = path.join(process.cwd(), "content", "blog", "en", `${slug}.mdx`);
...
export default function BlogPage() {
  return (
    <>
      <PageHero
        eyebrow="Blog"
        title="Insights on procurement and asset data quality"
        lead="Practical guidance on UNSPSC classification, spend visibility, and asset data for hard services, construction, and infrastructure teams."
      />
      ...
      <section id="blog-posts">
        <div className="container">
          <SectionTitle
            ...
            lead="Written for the teams doing the work: procurement, category management, and asset data."
          />
          <div className="article-grid">
            {[...blogPosts].sort((a, b) => b.publishedAt.localeCompare(a.publishedAt)).map((post) => {
              const fm = getMdxFrontmatter(post.slug);
        ...
        <div className="container">
          <div className="blog-podcast-grid">
            <div className="blog-podcast-copy">
              ...
              <h2>The Data Edge</h2>
              <p className="podcast-lead">Conversations on data quality and AI readiness for procurement and asset teams.</p>
